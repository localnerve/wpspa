...
exports.init = function(grunt) {
  ...
  var debugfs = require("fs");
  var debugExists = debugfs.existsSync(binPath);
  console.log("@@@ binPathExists: "+debugExists);
  var debugAargs = grunt.util.toArray(args);
  console.log("@@@ all args: "+debugAargs.join(","));
  var debugPjsExists = debugfs.existsSync(debugAargs[0]);
  console.log("@@@ phantomjs script exists: "+debugPjsExists);
  var debugTmpExists = debugfs.existsSync(debugAargs[1]);
  console.log("@@@ tmp file exists: "+debugTmpExists);
  var debugTestHarnessExists = debugfs.existsSync('/home/travis/build/localnerve/wpspa/test/mocha/index.html');
  console.log("@@@ test harness exists: "+debugTestHarnessExists);
  // @@@ end-debug
